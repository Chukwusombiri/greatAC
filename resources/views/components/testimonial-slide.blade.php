...
<section class="bg-inherit">
    <div class="mx-auto max-w-8xl px-4 py-12 sm:px-6 lg:me-0 lg:py-16 lg:ps-8 lg:pe-0 xl:py-24">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3 lg:items-center lg:gap-16">
            <div class="max-w-xl text-center sm:text-left">
                <h6 class=" text-center md:text-left text-md mb-4 font-light text-primary text-opacity-90 tracking-wider uppercase">Client Reviews</h6>
                <h2 class=" text-center md:text-left text-3xl sedan-regular-bold tracking-wide text-gray-200 sm:text-4xl md:text-5xl">
                    Our Results, in Their Words
                </h2>

                <p class=" text-center md:text-left mt-4 text-gray-400">
                    Don’t just take our word for it — our clients share how we’ve helped them achieve real results.
                </p>

                <div class="hidden lg:mt-8 lg:flex lg:gap-4">
                    <button aria-label="Previous slide" id="keen-slider-previous-desktop"
                        class="rounded-full border border-blue-600 p-3 text-blue-600 transition hover:bg-blue-600 hover:text-white">
        ...
        <div class="mt-8 flex justify-center gap-4 lg:hidden">
            <button aria-label="Previous slide" id="keen-slider-previous"
                class="rounded-full border border-blue-600 p-4 text-blue-600 transition hover:bg-blue-600 hover:text-white">
