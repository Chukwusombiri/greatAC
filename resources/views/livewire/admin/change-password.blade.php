        ...
        <div
            ...
            <div>
                ...
                <div class="w-full max-w-full px-3 shrink-0">
                    <div class="mb-4">
                        <label for="password" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700">New
                            Password</label>
                ...
                <div class="px-4 text-sm font-medium text-gray-800">
                    <span class="font-semibold">Heads up:</span> This will sign you out of all other active sessions—only this device will stay logged in.
                </div>

                <div class="w-full max-w-full px-3 shrink-0 md:flex-0 flex justify-end my-10">
                    <button wire:click="submit" type="button"
                        class="px-8 py-2 font-bold leading-normal text-center text-white align-middle transition-all ease-in border-0 rounded-lg shadow-md cursor-pointer text-xs bg-gray-700 lg:block tracking-tight-rem hover:shadow-xs hover:-translate-y-px active:opacity-85">update
                        password</button>
                </div>
            </div>
        </div>
